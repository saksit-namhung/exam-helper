...
PDF_PATH = os.environ.get("PDF_PATH", "/Users/saksit/Downloads/FIles/aws-certified-solutions-architect-associate-saa-c03.pdf")
OUT_PATH = os.environ.get("OUT_PATH", os.path.join(PROJECT_ROOT, "resources", "SAA-C03.json"))
